...
import controller.ControllerVenderBitcoin;
 ...
 * @author eric song
 */
public class JanelaVenderBitcoin extends javax.swing.JFrame {

    /**
     * Creates new form comprarBitcoin
     */
    public JanelaVenderBitcoin(Investidor investidor) {
        initComponents();
        controller = new ControllerVenderBitcoin(investidor, this);
    }

    public ControllerVenderBitcoin getController() {
        return controller;
    }

    public void setController(ControllerVenderBitcoin controller) {
    ...
    private void initComponents() {
        ...
        bitcoinLbl.setText("Digite o valor que deseja vender:");

        bitcoinTxt.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("VENDER BITCOIN");
...
//    }
    ...
    private ControllerVenderBitcoin controller;
