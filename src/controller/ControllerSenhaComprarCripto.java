...
import view.JanelaSenhaComprarCripto;
 ...
 * @author eric song
 */
public class ControllerSenhaComprarCripto {
    private JanelaSenhaComprarCripto view;
    private JanelaMenu viewM;

    public ControllerSenhaComprarCripto(JanelaSenhaComprarCripto view, JanelaMenu viewM) {
        this.view = view;
        this.viewM = viewM;
    }
    ...
    public void consultarSenha(){
        ...
        try{
            ...
            if(res.next()){
                ...
                JanelaComprarCripto cc = new JanelaComprarCripto(new Investidor(carteira, nome, cpf, senha));
