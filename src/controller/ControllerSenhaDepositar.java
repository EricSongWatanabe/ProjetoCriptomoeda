 ...
 * @author eric song
 */
public class ControllerSenhaDepositar {
    private JanelaMenu viewM;
    private JanelaSenhaDepositar view;

    public ControllerSenhaDepositar(JanelaMenu viewM, JanelaSenhaDepositar view) {
        this.viewM = viewM;
        this.view = view;
    }
    ...
    public void consultarSenha(){
        ...
        try{
            ...
            if(res.next()){
                ...
                JanelaDepositar d = new JanelaDepositar(new Investidor(carteira, nome, cpf, senha));
